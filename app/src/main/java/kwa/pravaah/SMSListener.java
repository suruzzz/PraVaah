                    ...
                    for(int i=0; i<msgs.length; i++) {
                        ...
                        try {
                         ...
                         /*   boolean isInserted = dbManager.insertUserDetails(message.getSender(), "", message.getPower(), message.getPump(),
                                    ...
                                    message.getTm(), "", "", "");*/
                            boolean isUpdated = dbManager.UpdateDetails(no,AddAlarm.Name,message.getPower(),message.getPump(),"",
                                    "",message.getErr(),message.getEventHrs(),message.getAuto(),message.getTm(),"",
                            "","");
